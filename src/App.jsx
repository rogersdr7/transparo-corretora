...
function openWhatsApp(msg = "Olá! Vim pelo site e quero um orçamento.") {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-50">
      ...
      <Routes>
        ...
        {/* fallback: qualquer rota inválida volta para a home */}
...
function Header() {
  return (
    <header className="sticky top-0 z-40 backdrop-blur border-b border-neutral-900/60 bg-neutral-950/75">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-2">
          <Link className="px-4 py-2 rounded-lg hover:bg-neutral-900" to="/consorcios">
            Consórcios
          </Link>
          <Link
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <p className="mt-4 text-neutral-300 text-lg">
              Especialistas em seguros e consórcios (imóveis, carros, motos e equipamentos).
              Atendimento consultivo, rápido e 100% on-line.
            </p>
      ...
      <section id="servicos" className="border-t border-neutral-900">
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="mt-8">
            <Link
              to="/consorcios"
              className="inline-flex items-center gap-2 px-4 py-3 rounded-xl bg-neutral-900 border border-neutral-800 hover:bg-neutral-800"
            >
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-4">
            <Faq q="Consórcio tem juros?">
              Não. Você paga apenas a <b>taxa de administração</b> e, quando previsto,
              <b> fundo de reserva</b>. A contemplação ocorre por sorteio ou lance.
            </Faq>
            ...
            <Faq q="Quais seguradoras/parceiros?">
              Trabalhamos com companhias líderes de mercado.
            </Faq>
          </div>
    ...
    <footer className="border-t border-neutral-900">
      <div className="max-w-6xl mx-auto px-4 py-10 grid md:grid-cols-3 gap-6 text-sm">
        ...
        <div>
          ...
          <p className="text-neutral-400">WhatsApp: {COMPANY.phoneHuman}</p>
